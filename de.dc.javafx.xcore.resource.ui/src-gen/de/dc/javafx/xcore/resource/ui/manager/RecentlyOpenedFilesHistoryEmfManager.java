...
import de.dc.javafx.xcore.resource.ui.file.RecentlyOpenedFilesHistoryFile;
...
public class RecentlyOpenedFilesHistoryEmfManager extends AbstractEmfManager<RecentlyOpenFileHistory> {
  @Override
  ...
  public IEmfFile<RecentlyOpenFileHistory> initFile() {
    return new RecentlyOpenedFilesHistoryFile();
  }
}
