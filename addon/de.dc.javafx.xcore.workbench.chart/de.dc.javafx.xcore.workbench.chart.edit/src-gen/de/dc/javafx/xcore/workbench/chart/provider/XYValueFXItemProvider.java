 ...
 * @generated
 */
public class XYValueFXItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		String label = ((XYValueFX) object).getX();
		return label == null || label.length() == 0 ? getString("_UI_XYValueFX_type")
				: getString("_UI_XYValueFX_type") + " " + label;
	}
