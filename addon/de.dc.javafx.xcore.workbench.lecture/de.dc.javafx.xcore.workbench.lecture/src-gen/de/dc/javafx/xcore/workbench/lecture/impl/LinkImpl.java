 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.javafx.xcore.workbench.lecture.impl.LinkImpl#getHref <em>Href</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.lecture.impl.LinkImpl#getAlt <em>Alt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends HtmlElementImpl implements Link {
	...
	protected EClass eStaticClass() {
		return LecturePackage.Literals.LINK;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LecturePackage.LINK__HREF, oldHref, href));
	}
	...
	public void setAlt(String newAlt) {
		...
		alt = newAlt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LecturePackage.LINK__ALT, oldAlt, alt));
	}
