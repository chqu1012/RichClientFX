 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.javafx.xcore.workbench.lecture.impl.FileContentImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileContentImpl extends ContentImpl implements FileContent {
	...
	protected EClass eStaticClass() {
		return LecturePackage.Literals.FILE_CONTENT;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LecturePackage.FILE_CONTENT__PATH, oldPath, path));
	}
