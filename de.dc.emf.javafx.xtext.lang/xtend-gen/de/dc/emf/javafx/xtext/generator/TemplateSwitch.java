...
public class TemplateSwitch extends JavafxSwitch<String> {
  ...
  public CharSequence casePieChartFX(final PieChartFX object) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("import javafx.geometry.Side;");
    _builder.newLine();
    _builder.append("import javafx.scene.chart.PieChart;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Base");
    String _firstUpper = StringExtensions.toFirstUpper(object.getName());
    _builder.append(_firstUpper);
    _builder.append(" extends PieChart{");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Base");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("setStartAngle(30);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void addSlice(String category, double value) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("getData().add(new Data(category, value));");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
