...
class FilteredElementEnabler extends JavafxSwitch<Boolean>{
	...
	override caseDerivedBean(DerivedBean object) {false}
	override caseBean(Bean object) {false}
	override caseBinding(Binding object) {false}
	override caseModelFX(ModelFX object) {false}
	
	override caseTableViewFX(TableViewFX object) {object.useFilter}
}