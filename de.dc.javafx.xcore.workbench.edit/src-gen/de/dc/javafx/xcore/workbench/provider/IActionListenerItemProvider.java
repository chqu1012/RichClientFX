	...
	protected void addOnActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IActionListener_onAction_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IActionListener_onAction_feature",
								"_UI_IActionListener_type"),
						WorkbenchPackage.Literals.IACTION_LISTENER__ON_ACTION, true, false, false,
