 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.javafx.xcore.workbench.extensions.impl.PerspectiveImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.extensions.impl.PerspectiveImpl#getRight <em>Right</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.extensions.impl.PerspectiveImpl#getBottom <em>Bottom</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.extensions.impl.PerspectiveImpl#getEditorArea <em>Editor Area</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerspectiveImpl extends ExtensionImpl implements Perspective {
	/**
	...
	protected EClass eStaticClass() {
		return ExtensionsPackage.Literals.PERSPECTIVE;
	}
	...
	public EList<View> getLeft() {
		if (left == null) {
			left = new EObjectResolvingEList<View>(View.class, this, ExtensionsPackage.PERSPECTIVE__LEFT);
		}
		return left;
	}
	...
	public EList<View> getRight() {
		if (right == null) {
			right = new EObjectResolvingEList<View>(View.class, this, ExtensionsPackage.PERSPECTIVE__RIGHT);
		}
		return right;
	}
	...
	public EList<View> getBottom() {
		if (bottom == null) {
			bottom = new EObjectResolvingEList<View>(View.class, this, ExtensionsPackage.PERSPECTIVE__BOTTOM);
		}
		return bottom;
	}
	...
	public EList<Editor> getEditorArea() {
		if (editorArea == null) {
			editorArea = new EObjectResolvingEList<Editor>(Editor.class, this,
					ExtensionsPackage.PERSPECTIVE__EDITOR_AREA);
		}
		return editorArea;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ExtensionsPackage.PERSPECTIVE__LEFT:
			return getLeft();
		case ExtensionsPackage.PERSPECTIVE__RIGHT:
			return getRight();
		case ExtensionsPackage.PERSPECTIVE__BOTTOM:
			return getBottom();
		case ExtensionsPackage.PERSPECTIVE__EDITOR_AREA:
