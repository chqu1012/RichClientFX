 ...
 */
package de.dc.javafx.xcore.workbench.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.dc.javafx.xcore.workbench.ide.contentassist.antlr.internal.InternalIdeDslParser;
import de.dc.javafx.xcore.workbench.services.IdeDslGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class IdeDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(IdeDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IdeDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIdeContainerAccess().getGroup(), "rule__IdeContainer__Group__0");
			...
			builder.put(grammarAccess.getIdeContainerAccess().getPackagePathAssignment_2(), "rule__IdeContainer__PackagePathAssignment_2");
			builder.put(grammarAccess.getIdeContainerAccess().getNameAssignment_4(), "rule__IdeContainer__NameAssignment_4");
	...
	@Override
	protected InternalIdeDslParser createParser() {
		InternalIdeDslParser result = new InternalIdeDslParser(null);
