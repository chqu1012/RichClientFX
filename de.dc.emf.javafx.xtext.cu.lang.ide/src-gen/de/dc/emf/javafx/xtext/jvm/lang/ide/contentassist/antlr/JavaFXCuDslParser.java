 ...
 */
package de.dc.emf.javafx.xtext.jvm.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.dc.emf.javafx.xtext.jvm.lang.ide.contentassist.antlr.internal.InternalJavaFXCuDslParser;
import de.dc.emf.javafx.xtext.jvm.lang.services.JavaFXCuDslGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class JavaFXCuDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(JavaFXCuDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JavaFXCuDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLineChartFXAccess().getTitleAssignment_5_1(), "rule__LineChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getLineChartFXAccess().getTitleSideAssignment_6_1(), "rule__LineChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getLineChartFXAccess().getShowLegendAssignment_7_1(), "rule__LineChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getLineChartFXAccess().getLegendSideAssignment_8_1(), "rule__LineChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getLineChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__LineChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getLineChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__LineChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getLineChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__LineChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getLineChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__LineChartFX__YAxisLabelAssignment_12_1");
			builder.put(grammarAccess.getPieChartFXAccess().getNameAssignment_4(), "rule__PieChartFX__NameAssignment_4");
			builder.put(grammarAccess.getPieChartFXAccess().getTitleAssignment_5_1(), "rule__PieChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getPieChartFXAccess().getTitleSideAssignment_6_1(), "rule__PieChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getPieChartFXAccess().getShowLegendAssignment_7_1(), "rule__PieChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getPieChartFXAccess().getLegendSideAssignment_8_1(), "rule__PieChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getPieChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__PieChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getPieChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__PieChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getPieChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__PieChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getPieChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__PieChartFX__YAxisLabelAssignment_12_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getNameAssignment_4(), "rule__AreaChartFX__NameAssignment_4");
			builder.put(grammarAccess.getAreaChartFXAccess().getTitleAssignment_5_1(), "rule__AreaChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getTitleSideAssignment_6_1(), "rule__AreaChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getShowLegendAssignment_7_1(), "rule__AreaChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getLegendSideAssignment_8_1(), "rule__AreaChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__AreaChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__AreaChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__AreaChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__AreaChartFX__YAxisLabelAssignment_12_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getNameAssignment_4(), "rule__BubbleChartFX__NameAssignment_4");
			builder.put(grammarAccess.getBubbleChartFXAccess().getTitleAssignment_5_1(), "rule__BubbleChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getTitleSideAssignment_6_1(), "rule__BubbleChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getShowLegendAssignment_7_1(), "rule__BubbleChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getLegendSideAssignment_8_1(), "rule__BubbleChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__BubbleChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__BubbleChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__BubbleChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__BubbleChartFX__YAxisLabelAssignment_12_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getNameAssignment_4(), "rule__ScatterChartFX__NameAssignment_4");
			builder.put(grammarAccess.getScatterChartFXAccess().getTitleAssignment_5_1(), "rule__ScatterChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getTitleSideAssignment_6_1(), "rule__ScatterChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getShowLegendAssignment_7_1(), "rule__ScatterChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getLegendSideAssignment_8_1(), "rule__ScatterChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__ScatterChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__ScatterChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__ScatterChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__ScatterChartFX__YAxisLabelAssignment_12_1");
			builder.put(grammarAccess.getBarChartFXAccess().getNameAssignment_4(), "rule__BarChartFX__NameAssignment_4");
			builder.put(grammarAccess.getBarChartFXAccess().getTitleAssignment_5_1(), "rule__BarChartFX__TitleAssignment_5_1");
			builder.put(grammarAccess.getBarChartFXAccess().getTitleSideAssignment_6_1(), "rule__BarChartFX__TitleSideAssignment_6_1");
			builder.put(grammarAccess.getBarChartFXAccess().getShowLegendAssignment_7_1(), "rule__BarChartFX__ShowLegendAssignment_7_1");
			builder.put(grammarAccess.getBarChartFXAccess().getLegendSideAssignment_8_1(), "rule__BarChartFX__LegendSideAssignment_8_1");
			builder.put(grammarAccess.getBarChartFXAccess().getXAxisTypeAssignment_9_1(), "rule__BarChartFX__XAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getBarChartFXAccess().getYAxisTypeAssignment_10_1(), "rule__BarChartFX__YAxisTypeAssignment_10_1");
			builder.put(grammarAccess.getBarChartFXAccess().getXAxisLabelAssignment_11_1(), "rule__BarChartFX__XAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getBarChartFXAccess().getYAxisLabelAssignment_12_1(), "rule__BarChartFX__YAxisLabelAssignment_12_1");
	...
	@Override
	protected InternalJavaFXCuDslParser createParser() {
		InternalJavaFXCuDslParser result = new InternalJavaFXCuDslParser(null);
