...
public class EmfSupportDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EmfSupportDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEcoreAccess().getModelItemProviderAdapterFactoryAssignment_5(), "rule__Ecore__ModelItemProviderAdapterFactoryAssignment_5");
			builder.put(grammarAccess.getEcoreAccess().getModelFactoryAssignment_7(), "rule__Ecore__ModelFactoryAssignment_7");
			builder.put(grammarAccess.getEcoreAccess().getRootTypeAssignment_9(), "rule__Ecore__RootTypeAssignment_9");
