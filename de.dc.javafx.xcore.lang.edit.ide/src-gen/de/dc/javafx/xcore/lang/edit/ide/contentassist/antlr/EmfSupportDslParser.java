...
public class EmfSupportDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EmfSupportDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEcoreAccess().getModelItemProviderAdapterFactoryAssignment_7(), "rule__Ecore__ModelItemProviderAdapterFactoryAssignment_7");
			builder.put(grammarAccess.getEcoreAccess().getModelFactoryAssignment_9(), "rule__Ecore__ModelFactoryAssignment_9");
			builder.put(grammarAccess.getEcoreAccess().getRootTypeAssignment_11(), "rule__Ecore__RootTypeAssignment_11");
			builder.put(grammarAccess.getEcoreAccess().getUseUndoRedoAssignment_13(), "rule__Ecore__UseUndoRedoAssignment_13");
