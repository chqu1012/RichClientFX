 ...
 */
package de.dc.javafx.xcore.lang.edit.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.dc.javafx.xcore.lang.edit.ide.contentassist.antlr.internal.InternalEmfSupportDslParser;
import de.dc.javafx.xcore.lang.edit.services.EmfSupportDslGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class EmfSupportDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(EmfSupportDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EmfSupportDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEcoreAccess().getGroup_31(), "rule__Ecore__Group_31__0");
			...
			builder.put(grammarAccess.getModelAccess().getEcoreAssignment(), "rule__Model__EcoreAssignment");
			builder.put(grammarAccess.getEcoreAccess().getNameAssignment_2(), "rule__Ecore__NameAssignment_2");
			builder.put(grammarAccess.getEcoreAccess().getPackagePathAssignment_5(), "rule__Ecore__PackagePathAssignment_5");
			builder.put(grammarAccess.getEcoreAccess().getModelItemProviderAdapterFactoryAssignment_8(), "rule__Ecore__ModelItemProviderAdapterFactoryAssignment_8");
			builder.put(grammarAccess.getEcoreAccess().getModelPackageAssignment_11(), "rule__Ecore__ModelPackageAssignment_11");
			builder.put(grammarAccess.getEcoreAccess().getModelFactoryAssignment_14(), "rule__Ecore__ModelFactoryAssignment_14");
			builder.put(grammarAccess.getEcoreAccess().getRootTypeAssignment_17(), "rule__Ecore__RootTypeAssignment_17");
			builder.put(grammarAccess.getEcoreAccess().getUseUndoRedoAssignment_20(), "rule__Ecore__UseUndoRedoAssignment_20");
			builder.put(grammarAccess.getEcoreAccess().getShowCommandStackAssignment_23(), "rule__Ecore__ShowCommandStackAssignment_23");
			builder.put(grammarAccess.getEcoreAccess().getShowPropertyViewAssignment_26(), "rule__Ecore__ShowPropertyViewAssignment_26");
			builder.put(grammarAccess.getEcoreAccess().getGenerateDemoAssignment_29(), "rule__Ecore__GenerateDemoAssignment_29");
			builder.put(grammarAccess.getEcoreAccess().getEditablesAssignment_31_2(), "rule__Ecore__EditablesAssignment_31_2");
	...
	@Override
	protected InternalEmfSupportDslParser createParser() {
		InternalEmfSupportDslParser result = new InternalEmfSupportDslParser(null);
