...
public class BaseFilteredContactTableView extends VBox {
	...
	private void initTableView() {
		filteredContactTableView = new TableView<Contact>();
		filteredContactTableView.setItems(contactFilteredList);
		VBox.setVgrow(filteredContactTableView, Priority.ALWAYS);
		getChildren().add(filteredContactTableView);
	...
	protected TableColumn<Contact,Contact> createColumn(String name, double width, Callback<TableColumn.CellDataFeatures<Contact,Contact>, ObservableValue<Contact>> cellFeatures) {
		...
		filteredContactTableView.getColumns().add(column);
		return column;
	}
