/**
 */
package de.dc.javafx.xcore.workbench.ide.model.util;
...
public class IdeAdapterFactory extends AdapterFactoryImpl {
	...
	protected IdeSwitch<Adapter> modelSwitch = new IdeSwitch<Adapter>() {
		@Override
		public Adapter caseIdeContainer(IdeContainer object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dc.javafx.xcore.workbench.ide.model.IdeContainer <em>Container</em>}'.
	 * <!-- begin-user-doc -->
