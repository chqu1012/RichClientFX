...
/**
 * This is the item provider adapter for a {@link de.dc.javafx.emfsupport.website.model.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ModelPackage.Literals.PAGE__NAME, true, false, false,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Page_body_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Page_body_feature", "_UI_Page_type"),
						ModelPackage.Literals.PAGE__BODY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Page_url_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Page_url_feature", "_UI_Page_type"),
						ModelPackage.Literals.PAGE__URL, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PAGE__AUTHOR);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ModelPackage.PAGE__BODY:
		case ModelPackage.PAGE__URL:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ModelPackage.PAGE__AUTHOR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(ModelPackage.Literals.PAGE__AUTHOR, ModelFactory.eINSTANCE.createAuthor()));
	}
