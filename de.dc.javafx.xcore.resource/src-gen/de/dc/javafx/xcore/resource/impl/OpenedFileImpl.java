...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Opened File</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OpenedFileImpl extends MinimalEObjectImpl.Container implements OpenedFile {
	...
	protected EClass eStaticClass() {
		return ResourcePackage.Literals.OPENED_FILE;
	}
	...
	public void setTimestamp(String newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.OPENED_FILE__TIMESTAMP, oldTimestamp,
					timestamp));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.OPENED_FILE__NAME, oldName, name));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.OPENED_FILE__PATH, oldPath, path));
	}
