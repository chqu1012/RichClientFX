 ...
 */
package de.dc.javafx.xcore.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.dc.javafx.xcore.lang.ide.contentassist.antlr.internal.InternalJavaFXDslParser;
import de.dc.javafx.xcore.lang.services.JavaFXDslGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class JavaFXDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(JavaFXDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JavaFXDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBindingTypeAccess().getAlternatives(), "rule__BindingType__Alternatives");
			...
			builder.put(grammarAccess.getTreeViewFXAccess().getGroup_7(), "rule__TreeViewFX__Group_7__0");
			builder.put(grammarAccess.getListViewFXAccess().getGroup(), "rule__ListViewFX__Group__0");
			builder.put(grammarAccess.getListViewFXAccess().getGroup_3(), "rule__ListViewFX__Group_3__0");
			builder.put(grammarAccess.getListViewFXAccess().getGroup_4(), "rule__ListViewFX__Group_4__0");
			...
			builder.put(grammarAccess.getTableViewFXAccess().getGroup_7(), "rule__TableViewFX__Group_7__0");
			builder.put(grammarAccess.getTableViewFXAccess().getGroup_8(), "rule__TableViewFX__Group_8__0");
			...
			builder.put(grammarAccess.getChartSeriesAccess().getGroup_4(), "rule__ChartSeries__Group_4__0");
			builder.put(grammarAccess.getChartSeriesAccess().getGroup_4_3(), "rule__ChartSeries__Group_4_3__0");
			builder.put(grammarAccess.getLineChartFXAccess().getGroup(), "rule__LineChartFX__Group__0");
			builder.put(grammarAccess.getLineChartFXAccess().getGroup_4(), "rule__LineChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getLineChartFXAccess().getGroup_12_3(), "rule__LineChartFX__Group_12_3__0");
			builder.put(grammarAccess.getPieChartFXAccess().getGroup(), "rule__PieChartFX__Group__0");
			builder.put(grammarAccess.getPieChartFXAccess().getGroup_4(), "rule__PieChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getPieChartFXAccess().getGroup_8_3(), "rule__PieChartFX__Group_8_3__0");
			builder.put(grammarAccess.getAreaChartFXAccess().getGroup(), "rule__AreaChartFX__Group__0");
			builder.put(grammarAccess.getAreaChartFXAccess().getGroup_4(), "rule__AreaChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getAreaChartFXAccess().getGroup_12_3(), "rule__AreaChartFX__Group_12_3__0");
			builder.put(grammarAccess.getBubbleChartFXAccess().getGroup(), "rule__BubbleChartFX__Group__0");
			builder.put(grammarAccess.getBubbleChartFXAccess().getGroup_4(), "rule__BubbleChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getBubbleChartFXAccess().getGroup_12_3(), "rule__BubbleChartFX__Group_12_3__0");
			builder.put(grammarAccess.getScatterChartFXAccess().getGroup(), "rule__ScatterChartFX__Group__0");
			builder.put(grammarAccess.getScatterChartFXAccess().getGroup_4(), "rule__ScatterChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getScatterChartFXAccess().getGroup_12_3(), "rule__ScatterChartFX__Group_12_3__0");
			builder.put(grammarAccess.getBarChartFXAccess().getGroup(), "rule__BarChartFX__Group__0");
			builder.put(grammarAccess.getBarChartFXAccess().getGroup_4(), "rule__BarChartFX__Group_4__0");
			...
			builder.put(grammarAccess.getBarChartFXAccess().getGroup_8_3(), "rule__BarChartFX__Group_8_3__0");
			builder.put(grammarAccess.getChartFXDataAccess().getGroup(), "rule__ChartFXData__Group__0");
			builder.put(grammarAccess.getChartFXDataAccess().getGroup_3(), "rule__ChartFXData__Group_3__0");
			builder.put(grammarAccess.getChartFXDataAccess().getGroup_4(), "rule__ChartFXData__Group_4__0");
			...
			builder.put(grammarAccess.getTreeViewFXAccess().getShowToolbarAssignment_6_1(), "rule__TreeViewFX__ShowToolbarAssignment_6_1");
			...
			builder.put(grammarAccess.getTableViewFXAccess().getShowPropertyViewAssignment_6_1(), "rule__TableViewFX__ShowPropertyViewAssignment_6_1");
			builder.put(grammarAccess.getTableViewFXAccess().getShowToolbarAssignment_7_1(), "rule__TableViewFX__ShowToolbarAssignment_7_1");
			builder.put(grammarAccess.getTableViewFXAccess().getGenerateDemoAssignment_8_1(), "rule__TableViewFX__GenerateDemoAssignment_8_1");
			...
			builder.put(grammarAccess.getChartSeriesAccess().getNameAssignment_2(), "rule__ChartSeries__NameAssignment_2");
			builder.put(grammarAccess.getChartSeriesAccess().getDataListAssignment_4_2(), "rule__ChartSeries__DataListAssignment_4_2");
			builder.put(grammarAccess.getChartSeriesAccess().getDataListAssignment_4_3_1(), "rule__ChartSeries__DataListAssignment_4_3_1");
			builder.put(grammarAccess.getLineChartFXAccess().getNameAssignment_2(), "rule__LineChartFX__NameAssignment_2");
			builder.put(grammarAccess.getLineChartFXAccess().getTitleAssignment_4_1(), "rule__LineChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getLineChartFXAccess().getTitleSideAssignment_5_1(), "rule__LineChartFX__TitleSideAssignment_5_1");
			builder.put(grammarAccess.getLineChartFXAccess().getShowLegendAssignment_6_1(), "rule__LineChartFX__ShowLegendAssignment_6_1");
			builder.put(grammarAccess.getLineChartFXAccess().getLegendSideAssignment_7_1(), "rule__LineChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getLineChartFXAccess().getXAxisTypeAssignment_8_1(), "rule__LineChartFX__XAxisTypeAssignment_8_1");
			builder.put(grammarAccess.getLineChartFXAccess().getYAxisTypeAssignment_9_1(), "rule__LineChartFX__YAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getLineChartFXAccess().getXAxisLabelAssignment_10_1(), "rule__LineChartFX__XAxisLabelAssignment_10_1");
			builder.put(grammarAccess.getLineChartFXAccess().getYAxisLabelAssignment_11_1(), "rule__LineChartFX__YAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getLineChartFXAccess().getSeriesAssignment_12_2(), "rule__LineChartFX__SeriesAssignment_12_2");
			builder.put(grammarAccess.getLineChartFXAccess().getSeriesAssignment_12_3_1(), "rule__LineChartFX__SeriesAssignment_12_3_1");
			builder.put(grammarAccess.getPieChartFXAccess().getNameAssignment_2(), "rule__PieChartFX__NameAssignment_2");
			builder.put(grammarAccess.getPieChartFXAccess().getTitleAssignment_4_1(), "rule__PieChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getPieChartFXAccess().getTitleSideAssignment_5_1(), "rule__PieChartFX__TitleSideAssignment_5_1");
			builder.put(grammarAccess.getPieChartFXAccess().getShowLegendAssignment_6_1(), "rule__PieChartFX__ShowLegendAssignment_6_1");
			builder.put(grammarAccess.getPieChartFXAccess().getLegendSideAssignment_7_1(), "rule__PieChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getPieChartFXAccess().getSeriesAssignment_8_2(), "rule__PieChartFX__SeriesAssignment_8_2");
			builder.put(grammarAccess.getPieChartFXAccess().getSeriesAssignment_8_3_1(), "rule__PieChartFX__SeriesAssignment_8_3_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getNameAssignment_2(), "rule__AreaChartFX__NameAssignment_2");
			builder.put(grammarAccess.getAreaChartFXAccess().getTitleAssignment_4_1(), "rule__AreaChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getTitleSideAssignment_5_1(), "rule__AreaChartFX__TitleSideAssignment_5_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getShowLegendAssignment_6_1(), "rule__AreaChartFX__ShowLegendAssignment_6_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getLegendSideAssignment_7_1(), "rule__AreaChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getXAxisTypeAssignment_8_1(), "rule__AreaChartFX__XAxisTypeAssignment_8_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getYAxisTypeAssignment_9_1(), "rule__AreaChartFX__YAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getXAxisLabelAssignment_10_1(), "rule__AreaChartFX__XAxisLabelAssignment_10_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getYAxisLabelAssignment_11_1(), "rule__AreaChartFX__YAxisLabelAssignment_11_1");
			builder.put(grammarAccess.getAreaChartFXAccess().getSeriesAssignment_12_2(), "rule__AreaChartFX__SeriesAssignment_12_2");
			builder.put(grammarAccess.getAreaChartFXAccess().getSeriesAssignment_12_3_1(), "rule__AreaChartFX__SeriesAssignment_12_3_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getNameAssignment_2(), "rule__BubbleChartFX__NameAssignment_2");
			builder.put(grammarAccess.getBubbleChartFXAccess().getTitleAssignment_4_1(), "rule__BubbleChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getTitleSideAssignment_5_1(), "rule__BubbleChartFX__TitleSideAssignment_5_1");
			...
			builder.put(grammarAccess.getBubbleChartFXAccess().getLegendSideAssignment_7_1(), "rule__BubbleChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getXAxisTypeAssignment_8_1(), "rule__BubbleChartFX__XAxisTypeAssignment_8_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getYAxisTypeAssignment_9_1(), "rule__BubbleChartFX__YAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getBubbleChartFXAccess().getXAxisLabelAssignment_10_1(), "rule__BubbleChartFX__XAxisLabelAssignment_10_1");
			...
			builder.put(grammarAccess.getBubbleChartFXAccess().getSeriesAssignment_12_2(), "rule__BubbleChartFX__SeriesAssignment_12_2");
			builder.put(grammarAccess.getBubbleChartFXAccess().getSeriesAssignment_12_3_1(), "rule__BubbleChartFX__SeriesAssignment_12_3_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getNameAssignment_2(), "rule__ScatterChartFX__NameAssignment_2");
			builder.put(grammarAccess.getScatterChartFXAccess().getTitleAssignment_4_1(), "rule__ScatterChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getTitleSideAssignment_5_1(), "rule__ScatterChartFX__TitleSideAssignment_5_1");
			...
			builder.put(grammarAccess.getScatterChartFXAccess().getLegendSideAssignment_7_1(), "rule__ScatterChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getXAxisTypeAssignment_8_1(), "rule__ScatterChartFX__XAxisTypeAssignment_8_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getYAxisTypeAssignment_9_1(), "rule__ScatterChartFX__YAxisTypeAssignment_9_1");
			builder.put(grammarAccess.getScatterChartFXAccess().getXAxisLabelAssignment_10_1(), "rule__ScatterChartFX__XAxisLabelAssignment_10_1");
			...
			builder.put(grammarAccess.getScatterChartFXAccess().getSeriesAssignment_12_2(), "rule__ScatterChartFX__SeriesAssignment_12_2");
			builder.put(grammarAccess.getScatterChartFXAccess().getSeriesAssignment_12_3_1(), "rule__ScatterChartFX__SeriesAssignment_12_3_1");
			builder.put(grammarAccess.getBarChartFXAccess().getNameAssignment_2(), "rule__BarChartFX__NameAssignment_2");
			builder.put(grammarAccess.getBarChartFXAccess().getTitleAssignment_4_1(), "rule__BarChartFX__TitleAssignment_4_1");
			builder.put(grammarAccess.getBarChartFXAccess().getTitleSideAssignment_5_1(), "rule__BarChartFX__TitleSideAssignment_5_1");
			builder.put(grammarAccess.getBarChartFXAccess().getShowLegendAssignment_6_1(), "rule__BarChartFX__ShowLegendAssignment_6_1");
			builder.put(grammarAccess.getBarChartFXAccess().getLegendSideAssignment_7_1(), "rule__BarChartFX__LegendSideAssignment_7_1");
			builder.put(grammarAccess.getBarChartFXAccess().getSeriesAssignment_8_2(), "rule__BarChartFX__SeriesAssignment_8_2");
			builder.put(grammarAccess.getBarChartFXAccess().getSeriesAssignment_8_3_1(), "rule__BarChartFX__SeriesAssignment_8_3_1");
			builder.put(grammarAccess.getChartFXDataAccess().getXValueAssignment_3_1(), "rule__ChartFXData__XValueAssignment_3_1");
			builder.put(grammarAccess.getChartFXDataAccess().getYValueAssignment_4_1(), "rule__ChartFXData__YValueAssignment_4_1");
	...
	@Override
	protected InternalJavaFXDslParser createParser() {
		InternalJavaFXDslParser result = new InternalJavaFXDslParser(null);
