 ...
 * "javafxlang". If a sample multi-page editor (also available
 * as a template) is registered for the same extension, it will
 * be able to open it.
 */

public class EmfEditNewWizard extends Wizard implements INewWizard {
	
	private EmfEditNewWizardPage page;
	private ISelection selection;
	private EmfEditModel model = new EmfEditModel();
	/**
	 * Constructor for ChartNewWizard.
	 */
	public EmfEditNewWizard() {
		super();
	...
	public void addPages() {
		page = new EmfEditNewWizardPage(selection, model);
		addPage(page);
	}
