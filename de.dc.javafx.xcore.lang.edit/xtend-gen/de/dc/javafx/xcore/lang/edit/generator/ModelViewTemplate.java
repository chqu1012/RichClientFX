...
public class ModelViewTemplate implements ICustomerGenerator<Ecore> {
  ...
  public String code(final Ecore ecore) {
    ...
    _builder.append("View extends Base");
    String _name_1 = ecore.getName();
    _builder.append(_name_1);
    _builder.append("View {");
    _builder.newLineIfNotEmpty();
    _builder.append(">>>>>>> branch \'master\' of https://github.com/chqu1012/de.dc.emf.javafx.xtext.lang.git");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    String _simpleName_3 = ecore.getRootType().getSimpleName();
