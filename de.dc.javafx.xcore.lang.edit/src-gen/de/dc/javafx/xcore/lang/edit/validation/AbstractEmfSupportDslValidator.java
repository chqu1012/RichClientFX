...
public abstract class AbstractEmfSupportDslValidator extends XbaseWithAnnotationsValidator {
	
	@Override
	protected List<EPackage> getEPackages() {
		List<EPackage> result = new ArrayList<EPackage>(super.getEPackages());
		result.add(de.dc.javafx.xcore.lang.edit.emfSupportDsl.EmfSupportDslPackage.eINSTANCE);
