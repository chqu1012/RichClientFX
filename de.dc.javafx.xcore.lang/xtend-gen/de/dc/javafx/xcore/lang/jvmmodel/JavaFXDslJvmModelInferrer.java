...
public class JavaFXDslJvmModelInferrer extends AbstractModelInferrer {
  ...
  protected void _infer(final TableViewFX element, final IJvmDeclaredTypeAcceptor acceptor, final boolean isPreIndexingPhase) {
    ...
    final Procedure1<JvmGenericType> _function = (JvmGenericType it) -> {
      ...
      String _plus_3 = ((packagePath + "model.") + _name_1);
      ...
      JvmField _field_9 = this._jvmTypesBuilder.toField(element, "properties", this._typeReferenceBuilder.typeRef(ObservableList.class, this._typeReferenceBuilder.typeRef((_plus_3 + "PropertyValue"))), _function_10);
      ...
      final Consumer<TableColumnFX> _function_11 = (TableColumnFX col) -> {
        ...
        String _plus_4 = (_firstLower + "Column");
        JvmField _field_10 = this._jvmTypesBuilder.toField(element, _plus_4, this._typeReferenceBuilder.typeRef(TableColumn.class, model, model));
        ...
        if (_isUseFilter) {
          ...
          String _plus_5 = (_firstLower_1 + "Filter");
          ...
          JvmField _field_11 = this._jvmTypesBuilder.toField(element, _plus_5, this._typeReferenceBuilder.typeRef(ObjectProperty.class, this._typeReferenceBuilder.typeRef(Predicate.class, model)), _function_12);
      ...
      final Procedure1<JvmConstructor> _function_12 = (JvmConstructor it_1) -> {
        StringConcatenationClient _client = new StringConcatenationClient() {
          ...
          protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
            ...
            boolean _isShowToolbar = element.isShowToolbar();
      ...
      JvmOperation _method = this._jvmTypesBuilder.toMethod(element, "showPropertyView", this._typeReferenceBuilder.typeRef("void"), _function_13);
      ...
      final Procedure1<JvmOperation> _function_14 = (JvmOperation it_1) -> {
        EList<JvmFormalParameter> _parameters = it_1.getParameters();
        JvmFormalParameter _parameter = this._jvmTypesBuilder.toParameter(element, "showToolbar", this._typeReferenceBuilder.typeRef(Boolean.class));
        this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
        StringConcatenationClient _client = new StringConcatenationClient() {
          @Override
          protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
            _builder.append("if (showToolbar) {");
            _builder.newLine();
            _builder.append("\t");
      ...
      JvmOperation _method_1 = this._jvmTypesBuilder.toMethod(element, "showToolbar", this._typeReferenceBuilder.typeRef("void"), _function_14);
      ...
      JvmOperation _method_2 = this._jvmTypesBuilder.toMethod(element, "initTableView", this._typeReferenceBuilder.typeRef("void"), _function_15);
      ...
      JvmOperation _method_3 = this._jvmTypesBuilder.toMethod(element, "initRightPane", this._typeReferenceBuilder.typeRef("void"), _function_16);
      ...
      JvmOperation _method_4 = this._jvmTypesBuilder.toMethod(element, "initTopPane", this._typeReferenceBuilder.typeRef("void"), _function_17);
      ...
      JvmOperation _method_5 = this._jvmTypesBuilder.toMethod(element, "createColumn", this._typeReferenceBuilder.typeRef(TableColumn.class), _function_18);
      ...
      JvmOperation _method_6 = this._jvmTypesBuilder.toMethod(element, "setInput", this._typeReferenceBuilder.typeRef("void"), _function_19);
      ...
      final Procedure1<JvmOperation> _function_20 = (JvmOperation it_1) -> {
        ...
        arg1.setName("type");
        String _simpleName_1 = element.getUsedModel().getSimpleName();
        String _plus_4 = ((packagePath + "model.") + _simpleName_1);
        arg1.setParameterType(this._typeReferenceBuilder.typeRef((_plus_4 + "Type")));
      ...
      JvmOperation _method_7 = this._jvmTypesBuilder.toMethod(element, "setFeatureFor", this._typeReferenceBuilder.typeRef("void"), _function_20);
      ...
      this._jvmTypesBuilder.<JvmOperation>operator_add(_members_19, _getter);
      ...
      this._jvmTypesBuilder.<JvmOperation>operator_add(_members_20, _getter_1);
    };
    ...
    String _name_1 = element.getName();
    String _plus_5 = ((packagePath + "model.") + _name_1);
    String _plus_6 = (_plus_5 + "PropertyValue");
    ...
    acceptor.<JvmGenericType>accept(this._jvmTypesBuilder.toClass(element, _plus_6, _function_3));
    boolean _isGenerateDemo = element.isGenerateDemo();
    if (_isGenerateDemo) {
      String _name_2 = element.getName();
      String _plus_7 = ((packagePath + "demo.") + _name_2);
      String _plus_8 = (_plus_7 + "Application");
      ...
      acceptor.<JvmGenericType>accept(this._jvmTypesBuilder.toClass(element, _plus_8), _function_4);
    }
  }
