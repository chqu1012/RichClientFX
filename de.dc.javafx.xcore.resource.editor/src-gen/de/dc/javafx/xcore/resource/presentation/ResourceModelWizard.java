/**
 */
package de.dc.javafx.xcore.resource.presentation;
...
import de.dc.javafx.xcore.resource.provider.ResourceEditPlugin;
...
public class ResourceModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS = Collections.unmodifiableList(Arrays.asList(
			ResourceEditorPlugin.INSTANCE.getString("_UI_ResourceEditorFilenameExtensions").split("\\s*,\\s*")));
	 ...
	 * @generated
	 */
	public static final String FORMATTED_FILE_EXTENSIONS = ResourceEditorPlugin.INSTANCE
			.getString("_UI_ResourceEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", ");
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE
				.getImageDescriptor(ResourceEditorPlugin.INSTANCE.getImage("full/wizban/NewResource")));
	}
		...
		try {
			...
			if (new File(fileURI.toFileString()).exists()) {
				if (!MessageDialog.openQuestion(getShell(),
						ResourceEditorPlugin.INSTANCE.getString("_UI_Question_title"), ResourceEditorPlugin.INSTANCE
			...
			return ResourceEditorAdvisor.openEditor(workbench, fileURI);
		} catch (Exception exception) {
			ResourceEditorPlugin.INSTANCE.log(exception);
			return false;
		}
	...
	public class ResourceModelWizardInitialObjectCreationPage extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			{
				resourceURILabel.setText(ResourceEditorPlugin.INSTANCE.getString("_UI_File_label"));
			...
			resourceURIBrowseFileSystemButton.setText(ResourceEditorPlugin.INSTANCE.getString("_UI_Browse_label"));

			resourceURIBrowseFileSystemButton.addSelectionListener(new SelectionAdapter() {
				@Override
				public void widgetSelected(SelectionEvent event) {
					String[] filters = ResourceEditor.FILE_EXTENSION_FILTERS
							.toArray(new String[ResourceEditor.FILE_EXTENSION_FILTERS.size()]);
					String[] files = ResourceEditorAdvisor.openFilePathDialog(getShell(), SWT.SAVE, filters);
					if (files.length > 0) {
		...
		protected boolean validatePage() {
			...
			if (extension == null || !FILE_EXTENSIONS.contains(extension)) {
				...
				setErrorMessage(
						ResourceEditorPlugin.INSTANCE.getString(key, new Object[] { FORMATTED_FILE_EXTENSIONS }));
				return false;
			}
		...
		protected Collection<String> getEncodings() {
			if (encodings == null) {
				...
				for (StringTokenizer stringTokenizer = new StringTokenizer(
						ResourceEditorPlugin.INSTANCE.getString("_UI_XMLEncodingChoices")); stringTokenizer
								.hasMoreTokens();) {
	...
	public void addPages() {
		...
		initialObjectCreationPage
				.setDescription(ResourceEditorPlugin.INSTANCE.getString("_UI_Wizard_initial_object_description"));
