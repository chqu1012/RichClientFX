/**
 */
package de.dc.javafx.emfsupport.website.model.impl;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see de.dc.javafx.emfsupport.website.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getPage_Body() {
	 ...
	 */
	@Override
	public EReference getPage_Author() {
	...
	public void createPackageContents() {
		...
		createEAttribute(pageEClass, PAGE__BODY);
		createEAttribute(pageEClass, PAGE__URL);
		createEReference(pageEClass, PAGE__AUTHOR);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getWebsite_Name(), theEcorePackage.getEString(), "name", null, 0, 1, Website.class,
		...
		initEAttribute(getPage_Name(), theEcorePackage.getEString(), "name", null, 0, 1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPage_Body(), theEcorePackage.getEString(), "body", null, 0, 1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPage_Url(), theEcorePackage.getEString(), "url", null, 0, 1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPage_Author(), this.getAuthor(), null, "author", null, 0, -1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(authorEClass, Author.class, "Author", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAuthor_Firstname(), theEcorePackage.getEString(), "firstname", null, 0, 1, Author.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAuthor_Lastname(), theEcorePackage.getEString(), "lastname", null, 0, 1, Author.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAuthor_Email(), theEcorePackage.getEString(), "email", null, 0, 1, Author.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
