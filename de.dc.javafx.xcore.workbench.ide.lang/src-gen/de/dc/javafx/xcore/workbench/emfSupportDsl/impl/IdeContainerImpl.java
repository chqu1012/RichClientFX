...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ide Container</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#getPackagePath <em>Package Path</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#getIdeFactory <em>Ide Factory</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#getIdePackage <em>Ide Package</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#getIdeItemProviderAdapterFactory <em>Ide Item Provider Adapter Factory</em>}</li>
 *   <li>{@link de.dc.javafx.xcore.workbench.emfSupportDsl.impl.IdeContainerImpl#isGenerateDemo <em>Generate Demo</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdeContainerImpl extends MinimalEObjectImpl.Container implements IdeContainer
{
  ...
  {
    return EmfSupportDslPackage.Literals.IDE_CONTAINER;
  }
  ...
  public void setPackagePath(String newPackagePath)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__PACKAGE_PATH, oldPackagePath, packagePath));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetIdeFactory(JvmTypeReference newIdeFactory, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY, oldIdeFactory, newIdeFactory);
  ...
  public void setIdeFactory(JvmTypeReference newIdeFactory)
  {
    if (newIdeFactory != ideFactory)
    {
      ...
      if (ideFactory != null)
        msgs = ((InternalEObject)ideFactory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY, null, msgs);
      if (newIdeFactory != null)
        msgs = ((InternalEObject)newIdeFactory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY, null, msgs);
      msgs = basicSetIdeFactory(newIdeFactory, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY, newIdeFactory, newIdeFactory));
  }
  ...
  public NotificationChain basicSetIdePackage(JvmTypeReference newIdePackage, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_PACKAGE, oldIdePackage, newIdePackage);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIdePackage(JvmTypeReference newIdePackage)
  {
    if (newIdePackage != idePackage)
    {
      NotificationChain msgs = null;
      if (idePackage != null)
        msgs = ((InternalEObject)idePackage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_PACKAGE, null, msgs);
      if (newIdePackage != null)
        msgs = ((InternalEObject)newIdePackage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_PACKAGE, null, msgs);
      msgs = basicSetIdePackage(newIdePackage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_PACKAGE, newIdePackage, newIdePackage));
  }
  ...
  public NotificationChain basicSetIdeItemProviderAdapterFactory(JvmTypeReference newIdeItemProviderAdapterFactory, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_ITEM_PROVIDER_ADAPTER_FACTORY, oldIdeItemProviderAdapterFactory, newIdeItemProviderAdapterFactory);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIdeItemProviderAdapterFactory(JvmTypeReference newIdeItemProviderAdapterFactory)
  {
    if (newIdeItemProviderAdapterFactory != ideItemProviderAdapterFactory)
    {
      ...
      if (ideItemProviderAdapterFactory != null)
        msgs = ((InternalEObject)ideItemProviderAdapterFactory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_ITEM_PROVIDER_ADAPTER_FACTORY, null, msgs);
      if (newIdeItemProviderAdapterFactory != null)
        msgs = ((InternalEObject)newIdeItemProviderAdapterFactory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EmfSupportDslPackage.IDE_CONTAINER__IDE_ITEM_PROVIDER_ADAPTER_FACTORY, null, msgs);
      msgs = basicSetIdeItemProviderAdapterFactory(newIdeItemProviderAdapterFactory, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__IDE_ITEM_PROVIDER_ADAPTER_FACTORY, newIdeItemProviderAdapterFactory, newIdeItemProviderAdapterFactory));
  }
  ...
  public void setGenerateDemo(boolean newGenerateDemo)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfSupportDslPackage.IDE_CONTAINER__GENERATE_DEMO, oldGenerateDemo, generateDemo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY:
        return basicSetIdeFactory(null, msgs);
      case EmfSupportDslPackage.IDE_CONTAINER__IDE_PACKAGE:
        return basicSetIdePackage(null, msgs);
      case EmfSupportDslPackage.IDE_CONTAINER__IDE_ITEM_PROVIDER_ADAPTER_FACTORY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EmfSupportDslPackage.IDE_CONTAINER__PACKAGE_PATH:
        return getPackagePath();
      case EmfSupportDslPackage.IDE_CONTAINER__NAME:
        return getName();
      case EmfSupportDslPackage.IDE_CONTAINER__IDE_FACTORY:
      ...
      case EmfSupportDslPackage.IDE_CONTAINER__GENERATE_DEMO:
