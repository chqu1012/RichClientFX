...
public class IdeDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected IdeDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (IdeDslGrammarAccess) access;
