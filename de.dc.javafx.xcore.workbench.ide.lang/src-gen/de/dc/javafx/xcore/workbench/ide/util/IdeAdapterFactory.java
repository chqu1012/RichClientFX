 ...
 */
package de.dc.javafx.xcore.workbench.ide.util;
...
public class IdeAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected IdeSwitch<Adapter> modelSwitch =
    new IdeSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.dc.javafx.xcore.workbench.ide.IdeContainer <em>Container</em>}'.
   * <!-- begin-user-doc -->
