    ...
    for (final IdeContainer ide : _filter) {
      {
        ...
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t\t");
        _builder_1.append("if (manager==null) {");
        _builder_1.newLine();
        _builder_1.append("\t\t\t");
        _builder_1.append("manager = new ");
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t");
        _builder_1.append("return manager;");
        _builder_1.newLine();
        _builder_1.append("\t");
        _builder_1.append("}");
        _builder_1.newLine();
        ...
        _builder_1.append("public IEmfManager<");
        _builder_1.append(model, "\t");
        _builder_1.append("> initEmfManager() {");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t\t");
        _builder_1.append("return new ");
        String _name_5 = ide.getName();
        ...
        String _replace_1 = ide.getPackagePath().replace(".", "/");
        String _plus = (_replace_1 + "/");
        String _name_6 = ide.getName();
