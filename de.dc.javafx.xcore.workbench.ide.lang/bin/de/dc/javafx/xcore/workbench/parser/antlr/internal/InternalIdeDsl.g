...
entryRuleIdeContainer returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIdeContainerRule()); }
	iv_ruleIdeContainer=ruleIdeContainer
	{ $current=$iv_ruleIdeContainer.current; }
	EOF;

// Rule IdeContainer
ruleIdeContainer returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			otherlv_12='IdeItemProviderAdapterFactory'
			{
		...
		(
			(
				lv_generateDemo_15_0='generateDemo'
				{
